# FIXME: I know I should clean up these rubocop errors...
#
# rubocop:disable AbcSize,BlockNesting,CyclomaticComplexity,MethodLength
...
def firewalldconfig_writeconf(conf, path = '/etc/firewalld/firewalld.conf')
  ...
  options_to_set.each do |key, keysym|
    fh.puts key + '=' + conf[keysym].to_s unless keysym == :done
  end
end
